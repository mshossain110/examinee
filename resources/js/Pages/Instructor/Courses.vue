    ...
    <MainLayout>
        ...
        <div class="container mx-auto">
            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-12 lg:col-span-8 2xl:col-span-9">world</div>
            </div>



            <p class="mt-5">This sidebar component is part of a larger, open-source library of Tailwind CSS components.
                Learn
                more
