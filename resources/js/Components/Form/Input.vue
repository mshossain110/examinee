<template>
    <div :class="(type === 'hidden') ? 'hidden' : ui.wrapper">
      ...
      <span v-if="(isLeading && leadingIconName) || $slots.leading" :class="leadingWrapperIconClass">
        <slot name="leading" :disabled="disabled" :loading="loading">
            <svg width="36" height="36" :class="leadingIconClass" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12,1A11,11,0,1,0,23,12,11,11,0,0,0,12,1Zm0,19a8,8,0,1,1,8-8A8,8,0,0,1,12,20Z" opacity=".25"/><path d="M10.14,1.16a11,11,0,0,0-9,8.92A1.59,1.59,0,0,0,2.46,12,1.52,1.52,0,0,0,4.11,10.7a8,8,0,0,1,6.66-6.61A1.42,1.42,0,0,0,12,2.69h0A1.57,1.57,0,0,0,10.14,1.16Z" class="spinner_ajPY"/></svg>
  ...
  import { useFormGroup } from '@/Services/useFormGroup'
  import { mergeConfig, looseToNumber } from '@/Services/utils'
  import { useInjectButtonGroup } from '@/Services/useButtonGroup'
  ...
  color: {
    ...
    red: {
      outline: 'shadow-sm bg-gray-50 dark:bg-gray-800 text-red-900 dark:text-white ring-1 ring-inset ring-red-300 dark:ring-red-700 focus:ring-2 focus:ring-primary-500 dark:focus:ring-primary-400'
    }
  },
  variant: {
  ...
  export default defineComponent({
    ...
    setup (props, { emit, slots }) {
      ...
      const size = computed<Sizes>(() => sizeButtonGroup.value ?? sizeFormGroup.value)
