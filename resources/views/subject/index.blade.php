				 ...
				 <li class="list-group-item">
				    ...
				    <div class="d-flex w-100 justify-content-between">
						...
						<p>
							...
							<a href="{{route('subject.destroy',$subject->id)}}" onclick="event.preventDefault();
					...
					<form id="delete-form" action="{{route('subject.destroy',$subject->id)}}" method="POST" style="display: none;">
	  		        	{{ csrf_field() }}
